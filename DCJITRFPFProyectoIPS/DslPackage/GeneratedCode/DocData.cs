...
namespace DNF.DCJITRFPFProyectoIPS
{
	...
	/// </summary>
	internal partial class DCJITRFPFProyectoIPSDocData : DCJITRFPFProyectoIPSDocDataBase
	{
		/// <summary>
		/// Constructs a new DCJITRFPFProyectoIPSDocData.
		/// </summary>
		public DCJITRFPFProyectoIPSDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a DCJITRFPFProyectoIPS document in memory.
	/// </summary>
	internal abstract partial class DCJITRFPFProyectoIPSDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new DCJITRFPFProyectoIPSDocDataBase.
		/// </summary>
		protected DCJITRFPFProyectoIPSDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::DNF.DCJITRFPFProyectoIPS.TapizER modelRoot = null;
			...
			global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::DNF.DCJITRFPFProyectoIPS.TapizER modelRoot = (global::DNF.DCJITRFPFProyectoIPS.TapizER)this.RootElement;
			...
			{
				global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSDiagram diagram = diagrams[0] as global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::DNF.DCJITRFPFProyectoIPS.TapizER modelRoot = this.RootElement as global::DNF.DCJITRFPFProyectoIPS.TapizER;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
