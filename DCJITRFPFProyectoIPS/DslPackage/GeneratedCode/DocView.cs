...
namespace DNF.DCJITRFPFProyectoIPS
{
	...
	/// </summary>
	internal partial class DCJITRFPFProyectoIPSDocView : DCJITRFPFProyectoIPSDocViewBase
	{
		/// <summary>
		/// Constructs a new DCJITRFPFProyectoIPSDocView.
		/// </summary>
		public DCJITRFPFProyectoIPSDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DCJITRFPFProyectoIPSDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new DCJITRFPFProyectoIPSDocView.
		/// </summary>
		protected DCJITRFPFProyectoIPSDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			DCJITRFPFProyectoIPSDocDataBase docData = this.DocData as DCJITRFPFProyectoIPSDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for DCJITRFPFProyectoIPSDocViewBase should be an DCJITRFPFProyectoIPSDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.DCJITRFPFProyectoIPSDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::DNF.DCJITRFPFProyectoIPS.DCJITRFPFProyectoIPSHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
