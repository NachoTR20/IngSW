...
namespace DNF.DCJITRFPFProyectoIPS
{
	...
	/// </summary>
	internal partial class DCJITRFPFProyectoIPSCommandSet : DCJITRFPFProyectoIPSCommandSetBase
	{
		/// <summary>
		/// Constructs a new DCJITRFPFProyectoIPSCommandSet.
		/// </summary>
		public DCJITRFPFProyectoIPSCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class DCJITRFPFProyectoIPSCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new DCJITRFPFProyectoIPSCommandSetBase.
		/// </summary>
		protected DCJITRFPFProyectoIPSCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewDCJITRFPFProyectoIPSExplorerCommand,
				typeof(DCJITRFPFProyectoIPSEditorFactory).GUID);
		...
		{
			DCJITRFPFProyectoIPSExplorerToolWindow explorer = this.DCJITRFPFProyectoIPSExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected DCJITRFPFProyectoIPSDocData CurrentDCJITRFPFProyectoIPSDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as DCJITRFPFProyectoIPSDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected DCJITRFPFProyectoIPSDocView CurrentDCJITRFPFProyectoIPSDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as DCJITRFPFProyectoIPSDocView;
			}
		}
		...
		/// </summary>
		protected DCJITRFPFProyectoIPSExplorerToolWindow DCJITRFPFProyectoIPSExplorerToolWindow
		{
			get
			{
				DCJITRFPFProyectoIPSExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(DCJITRFPFProyectoIPSExplorerToolWindow), true) as DCJITRFPFProyectoIPSExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				DCJITRFPFProyectoIPSExplorerToolWindow explorerWindow = this.DCJITRFPFProyectoIPSExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class DCJITRFPFProyectoIPSClipboardCommandSet : DCJITRFPFProyectoIPSClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new DCJITRFPFProyectoIPSClipboardCommandSet.
		/// </summary>
		public DCJITRFPFProyectoIPSClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class DCJITRFPFProyectoIPSClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new DCJITRFPFProyectoIPSClipboardCommandSetBase.
		/// </summary>
		protected DCJITRFPFProyectoIPSClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
