...
namespace DNF.DCJITRFPFProyectoIPS
{
	...
	/// </remarks>
	public partial class DCJITRFPFProyectoIPSHelpKeywordHelper : DCJITRFPFProyectoIPSHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new DCJITRFPFProyectoIPSHelpKeywordHelper.
		/// </summary>
		protected DCJITRFPFProyectoIPSHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DCJITRFPFProyectoIPSHelpKeywordHelper.
		/// </summary>
		public static DCJITRFPFProyectoIPSHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class DCJITRFPFProyectoIPSHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DCJITRFPFProyectoIPSHelpKeywordHelperBase.
		/// </summary>
		protected DCJITRFPFProyectoIPSHelpKeywordHelperBase()
			: base() { }
